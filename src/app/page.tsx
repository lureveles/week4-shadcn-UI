...
const CURRENCY_ACCOUNTS = [
  { code: "EUR", label: "EUR", accountId: "51568", balance: "10,000.00", flag: "🇪🇺" },
  { code: "AUD", label: "AUD", accountId: "30779", balance: "12.00", flag: "🇦🇺" },
  { code: "CAD", label: "CAD", accountId: "15376", balance: "25.00", flag: "🇨🇦" },
  { code: "GBP", label: "GBP", accountId: "13159", balance: "3,000.00", flag: "🇬🇧" },
]
  ...
  return (
    <div className="flex flex-1 flex-col gap-8 p-6">
      ...
      <section className="space-y-4">
        ...
        <p className="text-3xl font-bold tracking-tight">13,037.00 EUR</p>
